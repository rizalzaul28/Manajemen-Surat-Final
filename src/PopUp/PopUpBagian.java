 ...
 * @author rizan
 */
public class PopUpBagian extends javax.swing.JDialog {
    ...
    public PopUpBagian(java.awt.Frame parent, boolean b, Bagian bgn) throws SQLException {
        super(parent, b);
        initComponents();
        this.b = bgn;
        autoId();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form Tambah Bagian");
    ...
    private void bt_TambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_TambahActionPerformed
        try {
            ...
            kodeTambah.setId_ktgr(Integer.parseInt(lb_Id.getText()));
            kodeTambah.setKode(tf_Kode.getText());
            kodeTambah.setNama(tf_Nama.getText());
    ...
    private void bt_UbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_UbahActionPerformed
        try {
            ...
            kodeUbah.setId_ktgr(Integer.parseInt(lb_Id.getText()));
            kodeUbah.setKode(tf_Kode.getText());
            kodeUbah.setNama(tf_Nama.getText());
            kodeUbah.KodeUbah();
            reset();
            autoId();
    ...
    private void bt_HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_HapusActionPerformed
        try {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                kodeHapus.setId_ktgr(Integer.parseInt(lb_Id.getText()));
                kodeHapus.KodeHapus();
                autoId();
                reset();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new PopUpBagian(null, true, bgn).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(PopUpBagian.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
